...
local function lsp_highlight_document(client)
    ...
    if not illum_ok then return end
...
-- ::: assign LSP configs to exportable table :::

-- M is a namespace for placing exportable objects
local M = {}
...
M.setup = function()
    ...
    -- map Diagnostic names to icons ("signs")
    local signs = {
    ...
    -- assign local signs data to vim
...
if not status_ok then
    vim.notify("cmp_nvim_lsp failed")
    return
end
